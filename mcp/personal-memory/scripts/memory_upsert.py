...
from service.constants import SOURCE_MANUAL, STATUS_ACTIVE
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-type", default=SOURCE_MANUAL)
    parser.add_argument("--source-ref")
    parser.add_argument("--confidence", type=float, default=0.7)
    parser.add_argument("--importance", type=int, default=5)
    parser.add_argument("--status", default=STATUS_ACTIVE)
